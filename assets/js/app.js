...
function f(jQuery) {
  var $body = jquery__WEBPACK_IMPORTED_MODULE_0___default()('body'),
      $close = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#form-control-close'),
      $open = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#form-control-open'),
      $container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#form-container'),
      $fname = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#inputFname');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(f);
...
module.exports = __webpack_require__(/*! /Users/isaac/Development/the-elm/src/assets/js/app.js */"./src/assets/js/app.js");
